/**
 * FIRST-TIME address-poisoning detection — the on-chain half.
 *
...
import { DEFAULT_GIWA_RPC, DEFAULT_SEPOLIA_RPC } from './broadcast';
...
const EXPLORER: Partial<Record<ChainId, string>> = {
  'giwa-sepolia': env.VITE_GIWA_EXPLORER || 'https://sepolia-explorer.giwa.io',
  sepolia: 'https://eth-sepolia.blockscout.com',
};
const RPC: Partial<Record<ChainId, string>> = {
  'giwa-sepolia': DEFAULT_GIWA_RPC,
